...
export function EzsignfolderRequestCompoundFromJSONTyped(json: any, ignoreDiscriminator: boolean): EzsignfolderRequestCompound {
    ...
    return {
        ...
        'eEzsignfolderSendreminderfrequency': json['eEzsignfolderSendreminderfrequency'],
    };
}
...
export function EzsignfolderRequestCompoundToJSON(value?: EzsignfolderRequestCompound | null): any {
    ...
    return {
        ...
        'eEzsignfolderSendreminderfrequency': value.eEzsignfolderSendreminderfrequency,
    };
}
...
* @enum {string}
*/
export enum EzsignfolderRequestCompoundEEzsignfolderSendreminderfrequencyEnum {
    None = 'None',
    Daily = 'Daily',
    Weekly = 'Weekly'
}
