...
export interface EzsignsignerRequestCompound {
    ...
    /**
     * The ID of the tax assignment, Valid values are:
     * 1. No tax
     * 2. GST
     * 3. HST (ON)
     * 4. HST (NB)
    ...
    /**
     * The ID of the secret question, Valid values are:
     * 
     ...
     * 4. **Phone** means the Ezsignsigner will only be able to sign "In-Person" and will need to authenticate using SMS or Phone call. No email will be sent for invitation to sign. **Additional fee applies**.
     * @type {string}
     * @memberof EzsignsignerRequestCompound
     */
